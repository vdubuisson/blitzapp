...
describe('PlayersRoleUtility', () => {
  let spectator: SpectatorService<PlayersRoleUtility>;

  let playersStatusUtility: SpyObject<PlayersStatusUtility>;

  const createService = createServiceFactory({
    service: PlayersRoleUtility,
  ...
  describe('getNotPlayedRoles', () => {
    it('should return not played cards', () => {
      ...
      const notPlayedRoles = spectator.service.getNotPlayedRoles(
        players,
        cardList,
      );
  ...
  describe('isLoupGarou', () => {
    it('should return true if player has loup-garou role', () => {
      const result = spectator.service.isLoupGarou({
  ...
  describe('isKilledByInnocents', () => {
    it('should return true if player is killed by CHASSEUR', () => {
      const result = spectator.service.isKilledByInnocents({
  ...
  describe('removePowersFromInnocents', () => {
    it('should remove HEALTH_POTION from SORCIERE', () => {
      ...
      const newPlayers =
        spectator.service.removePowersFromInnocents(mockPlayers);
    ...
    it('should remove DEATH_POTION from SORCIERE', () => {
      ...
      playersStatusUtility.removeStatusFromPlayer
