...
export class RoleHandlersManager {
  private readonly injector = inject(Injector);

  private readonly currentPlayersState =
    inject(CurrentPlayersStore).state.asReadonly();

  private readonly roleHandlers = new Map<PlayerRole, RoleHandler>();
   ...
   */
  getHandler(role: PlayerRole): RoleHandler {
  ...
  private createRoleHandler(role: PlayerRole): RoleHandler {
