import { Component, WritableSignal, input, model, output, signal } from '@angular/core';
...
describe('GamePage', () => {
  ...
  beforeAll(async () => MockBuilder(GamePage).replace(PlayerComponent, PlayerComponentStub).mock(GameService));
