...
describe('VictoryPage', () => {
  ...
  beforeAll(() => MockBuilder(VictoryPage).mock(NewGameService).provide(provideLocationMocks()));
  ...
  beforeAll(() => {
    component = MockRender(VictoryPage, { victory: VictoryEnum.NONE }).point.componentInstance;
  });
