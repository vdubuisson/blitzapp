...
describe('NewGamePage', () => {
  ...
  beforeAll(async () => MockBuilder(NewGamePage).mock(NewGameService).mock(CardChoiceService).replace(NewPlayerComponent, NewPlayerComponentStub));
