...
import { Mock, MockBuilder, MockedComponentFixture, MockInstance, MockRender, MockReset, ngMocks } from 'ng-mocks';
...
describe('RolesChoicePage', () => {
  ...
  beforeAll(() => MockBuilder(RolesChoicePage).mock(CardChoiceService).mock(Router).mock(PlayerRoleNamePipe));
