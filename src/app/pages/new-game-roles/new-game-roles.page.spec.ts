...
import { MockBuilder, MockInstance, MockRender, MockReset, MockService, ngMocks } from 'ng-mocks';
...
import { Component, input, output, provideExperimentalZonelessChangeDetection, signal, WritableSignal } from '@angular/core';
...
export class PlayerComponentStub {
...
describe('NewGameRolesPage', () => {
  ...
  beforeAll(async () => MockBuilder(NewGameRolesPage).replace(PlayerComponent, PlayerComponentStub).mock(NewGameService).mock(CardChoiceService));
