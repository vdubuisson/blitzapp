...
import { MockBuilder, MockedComponentFixture, MockInstance, MockRender, MockReset, ngMocks } from 'ng-mocks';
...
describe('PlayerCardModalComponent', () => {
  ...
  beforeAll(() => MockBuilder(PlayerCardModalComponent).mock(DialogRef).mock(DIALOG_DATA));
