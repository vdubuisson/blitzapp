...
export const STATUS_LEGENDS: Record<PlayerStatusEnum, string> = {
  [PlayerStatusEnum.WOLF_TARGET]: `Ce joueur est la cible des loups-garous pour cette nuit.`,
  ...
  [PlayerStatusEnum.INJURED]: `Ce joueur a survécu à une première attaque de loup-garou.`,
  ...
  [PlayerStatusEnum.DEVOURED]: `Ce joueur vient d'être dévoré par les loups-garous. A la fin de la nuit il mourra.`,
};
