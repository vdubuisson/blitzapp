...
export const ROLES_RULES: Record<PlayerRole, string> = {
  [PlayerRole.NOT_SELECTED]: '',
  [PlayerRole.VILLAGEOIS]: `Son objectif est d'éliminer tous les loups-garous.

  Il n'a aucun pouvoir particulier. Pendant le jour il vote pour éliminer quelqu'un du village.`,
  [PlayerRole.LOUP_GAROU]: `Son objectif est d'éliminer tous les innocents.
  ...
  [PlayerRole.CHASSEUR]: `Son objectif est d'éliminer tous les loups-garous.

  Quand il meurt, il tue immédiatement le joueur de son choix.`,
  [PlayerRole.CUPIDON]: `Son objectif est d'éliminer tous les loups-garous.
  ...
  [PlayerRole.PETITE_FILLE]: `Son objectif est d'éliminer tous les loups-garous.
  ...
  [PlayerRole.SORCIERE]: `Son objectif est d'éliminer tous les loup-garous.
  ...
  [PlayerRole.VOLEUR]: `Si on joue le Voleur, il faut ajouter 2 cartes Simple Villageois dans la partie.
  ...
  [PlayerRole.VOYANTE]: `Son objectif est d'éliminer tous les loup-garous.

  Chaque nuit, elle peut regarder le rôle d'un joueur de son choix.`,
  [PlayerRole.JOUEUR_FLUTE]: `Son objectif est de charmer tous les autres joueurs.

  Chaque nuit, il charme 2 joueurs de son choix.

  Après son tour, les joueurs charmés sont appelés pour se découvrir.`,
  [PlayerRole.CORBEAU]: `Son objectif est d'éliminer tous les loup-garous.
  ...
  [PlayerRole.ENFANT_SAUVAGE]: `Son objectif peut changer en cours de partie.
  ...
  [PlayerRole.SALVATEUR]: `Son objectif est d'éliminer tous les loup-garous.
  ...
  [PlayerRole.GRAND_MECHANT_LOUP]: `Son objectif est d'éliminer tous les innocents.
  ...
  [PlayerRole.MONTREUR_OURS]: `Son objectif est d'éliminer tous les loups-garous.

  Tous les matins, si l'un de ses voisins est un loup-garou, alors son ours grogne.`,
  [PlayerRole.RENARD]: `Son objectif est d'éliminer tous les loups-garous.
  ...
  [PlayerRole.CHIEN_LOUP]: `Lors de la première nuit, il choisit s'il veut être un Villageois ou un Loup-Garou.
  ...
  [PlayerRole.ANCIEN]: `Son objectif est d'éliminer tous les loups-garous.
  ...
  [PlayerRole.IDIOT]: `Son objectif est d'éliminer tous les loups-garous.
  ...
  [PlayerRole.CHEVALIER]: `Son objectif est d'éliminer tous les loups-garous.
  ...
  [PlayerRole.BOUC]: `Son objectif est d'éliminer tous les loups-garous.
  ...
  [PlayerRole.SECTAIRE]: `Son objectif est d'éliminer tous les membres de l'autre groupe.
  ...
  [PlayerRole.PERE_LOUPS]: `Son objectif est d'éliminer tous les innocents.
