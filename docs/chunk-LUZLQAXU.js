import{a as T,b as y,c as I}from"./chunk-RTFILNCV.js";import"./chunk-WXI33M2S.js";import{a as A}from"./chunk-4OEPV6RE.js";import{a as e,b as x,c as n}from"./chunk-HE775GVB.js";import"./chunk-IZ4CWXLE.js";import"./chunk-4QV3BAJX.js";import{Ab as R,Db as L,Eb as q,Gb as c,Hb as m,La as t,Ma as f,W as v,Xb as C,db as j,fb as a,gc as O,jb as p,kb as d,lb as g,mb as S,nb as E,rb as h,zb as b}from"./chunk-NCRUEMZX.js";import"./chunk-TMC7WMLO.js";var P={[e.NOT_SELECTED]:"",[e.VILLAGEOIS]:`Son objectif est d'\xE9liminer tous les loups-garous.
  ...
  Le personnage infect\xE9 conserve son pouvoir de personnage, mais son objectif est maintenant de faire gagner les loups-garous.`};function N(r,o){if(r&1&&(p(0,"lgmj-accordion-item"),S(1,1),g(2,"img",2),c(3,"playerRoleImage"),c(4,"playerRoleName"),p(5,"span",3),b(6),c(7,"playerRoleName"),d(),E(),g(8,"span",4),d()),r&2){let u=o.$implicit,s=h();t(2),a("ngSrc",m(3,4,u))("alt",m(4,6,u)),t(4),R(m(7,8,u)),t(2),a("innerText",s.rules[u])}}var J=(()=>{let o=class o{constructor(s){this.playerRoleNamePipe=s,this.rules=P,this.roles=Object.values(e).filter(i=>i!==e.NOT_SELECTED).sort((i,l)=>this.playerRoleNamePipe.transform(i).localeCompare(this.playerRoleNamePipe.transform(l))),this.roleTrackBy=A}};o.\u0275fac=function(i){return new(i||o)(f(n))},o.\u0275cmp=v({type:o,selectors:[["lgmj-roles-rules"]],standalone:!0,features:[L([n]),q],decls:2,vars:2,consts:[[4,"ngFor","ngForOf","ngForTrackBy"],["header",""],["width","55","height","55",1,"role-img",3,"ngSrc","alt"],[1,"role-name"],[1,"rule",3,"innerText"]],template:function(i,l){i&1&&(p(0,"cdk-accordion"),j(1,N,9,10,"lgmj-accordion-item",0),d()),i&2&&(t(),a("ngForOf",l.roles)("ngForTrackBy",l.roleTrackBy))},dependencies:[C,n,x,O,I,y,T],styles:[".rule[_ngcontent-%COMP%]{line-height:1.3rem}.role-img[_ngcontent-%COMP%]{margin-right:var(--spacing-1)}"]});let r=o;return r})();export{J as RolesRulesPage};
