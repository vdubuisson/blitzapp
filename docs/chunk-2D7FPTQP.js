import{a as M,b as V,c as F}from"./chunk-QMM5HVDY.js";import"./chunk-PZKYXEXO.js";import{l as T}from"./chunk-LSYFHQUA.js";import{a as D}from"./chunk-7PEM3PSL.js";import{a as A,b as e,c}from"./chunk-KPQ7JVYE.js";import{b as U,f as N}from"./chunk-4Q6LSL4Z.js";import{$a as g,C as v,Ma as R,Na as b,Nb as O,Oa as C,Pa as n,Qa as l,R as u,Ra as a,Sa as m,V as j,Va as y,W as S,Wa as x,Xa as L,Z as h,Za as q,mb as P,nb as _,oa as r,qb as I,sb as p,tb as d,ya as E}from"./chunk-G2GMQCZE.js";import"./chunk-2NFLSA4Y.js";var w={[e.NOT_SELECTED]:"",[e.VILLAGEOIS]:`Son objectif est d'\xE9liminer tous les loups-garous.
  ...
  Le personnage infect\xE9 conserve son pouvoir de personnage, mais son objectif est maintenant de faire gagner les loups-garous.`};function B(t,i){if(t&1){let o=L();l(0,"lgmj-accordion-item",0),y(1,1),m(2,"img",2),p(3,"playerRoleImage"),p(4,"playerRoleName"),l(5,"span",3),P(6),p(7,"playerRoleName"),a(),l(8,"fa-icon",4),q("click",function(G){let H=j(o).$implicit,k=g();return S(k.showRoleCard(H,G))}),a(),x(),m(9,"span",5),a()}if(t&2){let o=i.$implicit,s=g();n("noIndicatorMargin",!0),r(2),n("ngSrc",d(3,8,o))("alt",d(4,10,o))("width",55)("height",55),r(4),_(d(7,12,o)),r(2),n("icon",s.expandIcon),r(),n("innerText",s.rules[o])}}var f=class t{playerRoleNamePipe=u(c);modalManager=u(T);destroyRef=u(h);rules=w;roles=Object.values(e).filter(i=>i!==e.NOT_SELECTED).toSorted((i,o)=>this.playerRoleNamePipe.transform(i).localeCompare(this.playerRoleNamePipe.transform(o)));expandIcon=N;showRoleCard(i,o){o.stopPropagation(),this.modalManager.showPlayerCard(i).pipe(v(),D(this.destroyRef)).subscribe()}static \u0275fac=function(o){return new(o||t)};static \u0275cmp=E({type:t,selectors:[["lgmj-help-roles-page"]],features:[I([c])],decls:3,vars:0,consts:[["data-testid","accordion-item",3,"noIndicatorMargin"],["header",""],[1,"role-img",3,"ngSrc","alt","width","height"],[1,"role-name"],["data-testid","expand-btn",1,"expand-icon",3,"click","icon"],[1,"rule",3,"innerText"]],template:function(o,s){o&1&&(l(0,"cdk-accordion"),b(1,B,10,14,"lgmj-accordion-item",0,R),a()),o&2&&(r(),C(s.roles))},dependencies:[O,F,V,M,U,c,A],styles:[".rule[_ngcontent-%COMP%]{line-height:1.3rem}.role-img[_ngcontent-%COMP%]{margin-right:var(--spacing-1)}.expand-icon[_ngcontent-%COMP%]{margin-left:auto;margin-right:var(--spacing-1)}"],changeDetection:0})};export{f as default};
