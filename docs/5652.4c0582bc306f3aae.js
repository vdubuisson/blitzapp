...
(self.webpackChunkloup_garou_mj = self.webpackChunkloup_garou_mj || []).push([
  [5652],
  {
    ...
    5652: (z, g, c) => {
      c.r(g), c.d(g, { ion_button: () => E, ion_icon: () => M });
      var i = c(1308),
        v = c(9658),
        p = c(5730),
        u = c(4147),
      ...
      const l = (o, t, r, n, e) => (
          ...
          n && 'ios' === r
            ...
            : e && 'md' === r
            ? (o = y(e))
            : (!o && t && !w(t) && (o = t), h(o) && (o = y(o))),
          h(o) && '' !== o.trim() && '' === o.replace(/[a-z]|-|\d/gi, '')
            ? o
            : null
        ),
        f = (o) => (h(o) && ((o = o.trim()), w(o)) ? o : null),
        ...
        E = class {
          ...
          render() {
            const o = (0, v.b)(this),
              ...
              $ = void 0 === A && this.inItem ? 'small' : A,
              j = void 0 === O ? 'button' : 'a',
              Z =
                'button' === j
                  ? { type: r }
                  : { download: this.download, href: O, rel: e, target: b };
            let C = this.fill;
            return (
              null == C &&
      ...
      const I = (o) => {
          if (1 === o.nodeType) {
            ...
            for (let t = 0; t < o.attributes.length; t++) {
              const r = o.attributes[t].name;
              if (h(r) && 0 === r.toLowerCase().indexOf('on')) return !1;
            }
      ...
      const M = class {
          ...
          componentWillLoad() {
            this.inheritedAttributes = ((o, t = []) => {
              ...
              return (
                t.forEach((n) => {
                  o.hasAttribute(n) &&
                    (null !== o.getAttribute(n) && (r[n] = o.getAttribute(n)),
                    o.removeAttribute(n));
                }),
                r
              );
          ...
          loadIcon() {
            if (this.isVisible) {
              ...
              if (t)
                if (m.has(t)) this.svgContent = m.get(t);
                else if (t.startsWith('data:')) {
                  const n = _.parseFromString(
                    t,
                    'text/html'
                  ).body.querySelector('svg');
                  this.svgContent = null !== n ? n.outerHTML : '';
                } else
                  ((o, t) => {
                    let r = L.get(o);
                    if (!r) {
                          ...
                          return n.text().then((e) => {
                            e &&
                              ...
                              (e = ((o) => {
                                ...
                                t.innerHTML = o;
                                for (
                                  let n = t.childNodes.length - 1;
                                  n >= 0;
                                  n--
                                )
                                  'svg' !==
                                    t.childNodes[n].nodeName.toLowerCase() &&
                                    t.removeChild(t.childNodes[n]);
                                const r = t.firstElementChild;
                                if (r && 'svg' === r.nodeName.toLowerCase()) {
                                  const n = r.getAttribute('class') || '';
                                  if (
                                    (r.setAttribute(
                                      'class',
                                      (n + ' s-ion-icon').trim()
                    ...
                    return r;
                  })(t, this.sanitize).then(() => (this.svgContent = m.get(t)));
            }
              ...
              Object.assign(
                {
                  ...
                  role: 'img',
                  class: Object.assign(
                    Object.assign({ [e]: !0 }, V(this.color)),
                    {
        ...
        S = () =>
          ...
          'md',
        V = (o) => (o ? { 'ion-color': !0, [`ion-color-${o}`]: !0 } : null);
      M.style =
        ...
        x = (function () {
          var a = (0, i.Z)(function* (s, l, f, w) {
            if (null != s && '#' !== s[0] && !k.test(s)) {
              ...
              if (h) return l?.preventDefault(), h.push(s, f, w);
            }
            return !1;
          });
          return function (l, f, w, h) {
