import{a as A,b as P,c as U}from"./chunk-V653OPGB.js";import"./chunk-WXI33M2S.js";import{a as e,b as O,c as u}from"./chunk-RMBZ327K.js";import"./chunk-PFFPMRYK.js";import"./chunk-W25ZRW3S.js";import{Ab as L,Bb as q,Eb as C,Fb as x,Hb as p,Ib as d,Ma as t,Na as f,_ as v,eb as m,gc as I,ib as j,jb as S,kb as E,lb as l,mb as a,nb as g,ob as h,pb as b,tb as R}from"./chunk-YSE26K7C.js";import"./chunk-KFZQC3P5.js";var N={[e.NOT_SELECTED]:"",[e.VILLAGEOIS]:`Son objectif est d'\xE9liminer tous les loups-garous.
  ...
  Le personnage infect\xE9 conserve son pouvoir de personnage, mais son objectif est maintenant de faire gagner les loups-garous.`};function y(r,i){if(r&1&&(l(0,"lgmj-accordion-item"),h(1,0),g(2,"img",1),p(3,"playerRoleImage"),p(4,"playerRoleName"),l(5,"span",2),L(6),p(7,"playerRoleName"),a(),b(),g(8,"span",3),a()),r&2){let n=i.$implicit,s=R();t(2),m("ngSrc",d(3,4,n))("alt",d(4,6,n)),t(4),q(d(7,8,n)),t(2),m("innerText",s.rules[n])}}var J=(()=>{let i=class i{constructor(s){this.playerRoleNamePipe=s,this.rules=N,this.roles=Object.values(e).filter(o=>o!==e.NOT_SELECTED).sort((o,c)=>this.playerRoleNamePipe.transform(o).localeCompare(this.playerRoleNamePipe.transform(c)))}};i.\u0275fac=function(o){return new(o||i)(f(u))},i.\u0275cmp=v({type:i,selectors:[["lgmj-roles-rules"]],standalone:!0,features:[C([u]),x],decls:3,vars:0,consts:[["header",""],["width","55","height","55",1,"role-img",3,"ngSrc","alt"],[1,"role-name"],[1,"rule",3,"innerText"]],template:function(o,c){o&1&&(l(0,"cdk-accordion"),S(1,y,9,10,"lgmj-accordion-item",null,j),a()),o&2&&(t(),E(c.roles))},dependencies:[u,O,I,U,P,A],styles:[".rule[_ngcontent-%COMP%]{line-height:1.3rem}.role-img[_ngcontent-%COMP%]{margin-right:var(--spacing-1)}"]});let r=i;return r})();export{J as RolesRulesPage};
