  ...
  [5168],
  {
      ...
      const c = class {
          constructor(t) {
            (0, n.r)(this, t),
              ...
              (this.disabled = !1),
              (this.value = 'on'),
              (this.enableOnOffLabels = b.c.get('toggleOnOffLabels')),
              (this.onClick = (r) => {
                r.preventDefault(),
          ...
          onMove(t) {
            f((0, m.i)(this.el), this.checked, t.deltaX, -10) &&
              ((this.checked = !this.checked), (0, w.c)());
          }
          onEnd(t) {
            (this.activated = !1),
          ...
          render() {
            const {
              ...
              g = (0, b.b)(this),
              { label: O, labelId: C, labelText: D } = (0, u.d)(k, v),
              M = this.getValue(),
              L = (0, m.i)(k) ? 'rtl' : 'ltr';
            return (
              (0, u.e)(!0, k, E, a ? M : '', l),
              (0, n.h)(
                n.H,
                {
                  ...
                  'aria-labelledby': O ? C : null,
                  'aria-checked': `${a}`,
                  'aria-hidden': l ? 'true' : null,
                  role: 'switch',
                  class: (0, e.c)(r, {
                    [g]: !0,
                    'in-item': (0, e.h)('ion-item', k),
                    'toggle-activated': t,
                    'toggle-checked': a,
                    'toggle-disabled': l,
                    interactive: !0,
                ...
                (0, n.h)(
                  ...
                  _ &&
                    'ios' === g && [
                      this.renderOnOffSwitchLabels(g, !0),
                      this.renderOnOffSwitchLabels(g, !1),
                    ],
                  (0, n.h)(
                    'div',
                    ...
                    (0, n.h)(
                      ...
                      _ && 'md' === g && this.renderOnOffSwitchLabels(g, a)
                    )
                  )
                ),
    ...
    2854: (y, p, o) => {
      ...
      const n = (e, i) => null !== i.closest(e),
        ...
        w = /^[a-z][a-z0-9+\-.]*:/,
        m = (function () {
          var e = (0, x.Z)(function* (i, s, c, f) {
            if (null != i && '#' !== i[0] && !w.test(i)) {
              const h = document.querySelector('ion-router');
              if (h) return s?.preventDefault(), h.push(i, c, f);
            }
            return !1;
          });
          return function (s, c, f, h) {
