  ...
  [1186],
  {
    4147: (M, u, i) => {
      ...
      const p = (d, ...h) => console.warn(`[Ionic Warning]: ${d}`, ...h),
        l = (d, ...h) => console.error(`[Ionic Error]: ${d}`, ...h),
        f = (d, ...h) =>
          console.error(
    ...
    3583: (M, u, i) => {
      i.r(u), i.d(u, { ion_reorder: () => I, ion_reorder_group: () => b });
      var p = i(5861),
        l = i(1308),
        f = i(2357),
        d = i(9658),
      ...
      const b = class {
          constructor(e) {
            (0, l.r)(this, e),
              (this.ionItemReorder = (0, l.e)(this, 'ionItemReorder', 7)),
              (this.lastToIndex = -1),
              (this.cachedHeights = []),
              (this.scrollElTop = 0),
          ...
          onMove(e) {
            ...
            if (m !== this.lastToIndex) {
              const P = E(t);
              (this.lastToIndex = m), (0, g.b)(), this.reorderMove(P, m);
            }
