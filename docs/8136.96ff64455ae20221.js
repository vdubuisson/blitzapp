...
(self.webpackChunkloup_garou_mj = self.webpackChunkloup_garou_mj || []).push([
  [8136],
  {
    8136: (T, x, o) => {
        ...
        O = class {
          constructor(t) {
            (0, i.r)(this, t),
              ...
              (this.lastOnEnd = 0),
              (this.blocker = w.G.createBlocker({ disableScroll: !0 })),
              (this.isAnimating = !1),
              (this._isOpen = !1),
          ...
          loadAnimation() {
            ...
            return (0, u.Z)(function* () {
              ...
              (e === t.width && void 0 !== t.animation) ||
                ...
                (t.animation = yield c.m._createAnimation(t.type, t)),
          ...
          updateState() {
            ...
            this.gesture && this.gesture.enable(t && this.swipeGesture),
              ...
              this.disabled || c.m._setActiveMenu(this),
      ...
      const S = (function () {
          var t = (0, u.Z)(function* (e) {
            const n = yield c.m.get(e);
        ...
        L = class {
          constructor(t) {
            ...
            (0, i.r)(this, t),
              ...
              (this.autoHide = !0),
              (this.type = 'button'),
              (this.onClick = (0, u.Z)(function* () {
                return c.m.toggle(e.menu);
              }));
          }
          componentWillLoad() {
            this.inheritedAttributes = (0, l.i)(this.el);
      ...
      z.style = ':host(.menu-toggle-hidden){display:none}';
    },
    2854: (T, x, o) => {
      o.d(x, { c: () => m, g: () => w, h: () => i, o: () => c });
      var u = o(5861);
      const i = (a, s) => null !== s.closest(a),
        ...
        l = /^[a-z][a-z0-9+\-.]*:/,
        c = (function () {
          var a = (0, u.Z)(function* (s, r, _, k) {
            if (null != s && '#' !== s[0] && !l.test(s)) {
              const b = document.querySelector('ion-router');
              if (b) return r?.preventDefault(), b.push(s, _, k);
            }
            return !1;
          });
          return function (r, _, k, b) {
