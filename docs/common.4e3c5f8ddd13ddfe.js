  ...
  [8592],
  {
                  ...
                  const v =
                    'string' == typeof _
                      ? null === (y = s.ownerDocument) || void 0 === y
                        ...
                        : y.createElement(_)
                      : _;
                  E.forEach((r) => v.classList.add(r)),
                    Object.assign(v, w),
                    s.appendChild(v),
                    yield new Promise((r) => (0, l.c)(v, r));
                } else if (
                  s.children.length > 0 &&
    ...
    6642: (O, g, i) => {
      ...
      const a = 'ion-content',
        ...
        c = (function () {
          var h = (0, e.Z)(function* (v) {
            return t(v)
              ? (yield new Promise((r) => (0, l.c)(v, r)), v.getScrollElement())
              : v;
          });
          return function (r) {
        ...
        T = (h, v) => {
          t(h) ? (h.scrollY = v) : h.style.removeProperty('overflow');
        };
    },
    2357: (O, g, i) => {
      i.d(g, {
            ...
            c.appendChild(d),
              ...
              s.forEach((E) => {
                ...
                for (let T = y.length - 1; T >= 0; T--) {
                  ...
                  const v = n(h);
                  for (let r = 0; r < v.length; r++) l(v[r]);
                }
              });
            const m = n(c);
    ...
    1316: (O, g, i) => {
      ...
      const o = () => {
        ...
        h = (r) => {
          (u = Object.assign({}, a)), (a = v(r.visualViewport));
        },
        v = (r) => ({
      ...
      const a = (s, o, t, c, d) => {
        ...
        return (0, n.createGesture)({
          ...
          canStart: (r) =>
            ((r) => {
              const { startX: D } = r;
              return _ ? D >= m.innerWidth - 50 : D <= 50;
            })(r) && o(),
          onStart: t,
          onMove: (r) => {
            const D = E(r) / m.innerWidth;
            c(D);
          },
          onEnd: (r) => {
            const M = E(r),
            ...
            let x = 0;
            if (p > 5) {
              const L = p / Math.abs(P);
              x = Math.min(L, 540);
            }
            d(f, A <= 0 ? 0.01 : (0, e.l)(0, A, 0.9999), x);
          },
        });
      };
    },
    ...
    6519: (O, g, i) => {
      ...
      function y(f, C) {
        if (1 & f) {
          ...
          e.TgZ(0, 'ion-checkbox', 15),
            e.NdJ('ionChange', function (L) {
              e.CHM(p);
              const S = e.oxw(2);
              return e.KtG(S.onCheckedChange(L));
            }),
            e.qZA();
        }
        if (2 & f) {
      ...
      function T(f, C) {
        if ((1 & f && e._UZ(0, 'ion-radio', 16), 2 & f)) {
          const p = e.oxw(2);
      ...
      function A(f, C) {
        if (
          (1 & f &&
            (e.TgZ(0, 'div', 20), e.YNc(1, D, 3, 3, 'span', 24), e.qZA()),
          2 & f)
        ) {
          const p = e.oxw(2);
          e.xp6(1),
      ...
      class k {
        ...
        set selectableRoles(C) {
          ...
          this.player.role !== t.k.NOT_SELECTED &&
            ...
            (this.sortedRoles = p.sort((x, L) =>
              this.playerRoleNamePipe
                .transform(x)
                .localeCompare(this.playerRoleNamePipe.transform(L))
            ));
        }
        onCheckedChange(C) {
