import{a as y,b as x,c as I}from"./chunk-G2S7M5CP.js";import"./chunk-SR2PWE2P.js";import{a as P,b as e,c as a}from"./chunk-MTEQUKMH.js";import"./chunk-7VMWENNI.js";import{$a as R,Ma as f,Na as j,Nb as C,Oa as S,Pa as d,Qa as t,R as g,Ra as l,Sa as c,Va as h,Wa as E,mb as b,nb as L,oa as s,qb as q,sb as n,tb as u,ya as v}from"./chunk-5NQWZ6JI.js";import"./chunk-2NFLSA4Y.js";var O={[e.NOT_SELECTED]:"",[e.VILLAGEOIS]:`Son objectif est d'\xE9liminer tous les loups-garous.
  ...
  Le personnage infect\xE9 conserve son pouvoir de personnage, mais son objectif est maintenant de faire gagner les loups-garous.`};function A(r,i){if(r&1&&(t(0,"lgmj-accordion-item",0),h(1,1),c(2,"img",2),n(3,"playerRoleImage"),n(4,"playerRoleName"),t(5,"span",3),b(6),n(7,"playerRoleName"),l(),E(),c(8,"span",4),l()),r&2){let o=i.$implicit,p=R();s(2),d("ngSrc",u(3,6,o))("alt",u(4,8,o))("width",55)("height",55),s(4),L(u(7,10,o)),s(2),d("innerText",p.rules[o])}}var m=class r{playerRoleNamePipe=g(a);rules=O;roles=Object.values(e).filter(i=>i!==e.NOT_SELECTED).toSorted((i,o)=>this.playerRoleNamePipe.transform(i).localeCompare(this.playerRoleNamePipe.transform(o)));static \u0275fac=function(o){return new(o||r)};static \u0275cmp=v({type:r,selectors:[["lgmj-help-roles-page"]],features:[q([a])],decls:3,vars:0,consts:[["data-testid","accordion-item"],["header",""],[1,"role-img",3,"ngSrc","alt","width","height"],[1,"role-name"],[1,"rule",3,"innerText"]],template:function(o,p){o&1&&(t(0,"cdk-accordion"),j(1,A,9,12,"lgmj-accordion-item",0,f),l()),o&2&&(s(),S(p.roles))},dependencies:[C,I,x,y,a,P],styles:[".rule[_ngcontent-%COMP%]{line-height:1.3rem}.role-img[_ngcontent-%COMP%]{margin-right:var(--spacing-1)}"],changeDetection:0})};export{m as default};
