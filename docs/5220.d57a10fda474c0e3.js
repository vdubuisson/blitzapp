  ...
  [5220],
  {
    5220: (y, s, n) => {
      ...
      class c {
        constructor(e) {
          (this.route = e),
            (this.victory = this.route.snapshot.queryParamMap.get('victory')),
            (this.victoryTitle =
              this.victory === o.K.NONE ? 'Match nul' : 'Victoire');
        }
      }
      (c.ɵfac = function (e) {
        return new (e || c)(t.Y36(u.gz));
      }),
        (c.ɵcmp = t.Xpm({
          type: c,
          selectors: [['lgmj-victory']],
          standalone: !0,
          features: [t.jDz],
          decls: 16,
          vars: 4,
          consts: [
            ...
            ['id', 'victory-subtitle'],
            ['id', 'victory-title'],
            ['routerLink', '/', 1, 'ion-margin-horizontal'],
            [
              'routerLink',
              '/new-game',
              'color',
          ...
          template: function (e, l) {
            1 & e &&
              ...
              t.TgZ(1, 'ion-content')(2, 'div', 1)(3, 'ion-note', 2)(
                4,
                'h2',
                3
              ),
              ...
              t.qZA()(),
              t._UZ(6, 'hr'),
              t.TgZ(7, 'ion-text', 2)(8, 'h1', 4),
              t._uU(9),
              t.ALo(10, 'victoryName'),
              t.qZA()(),
              t.TgZ(11, 'ion-button', 5),
              t._uU(12, "Retourner \xe0 l'accueil"),
              t.qZA(),
              t._UZ(13, 'br'),
              t.TgZ(14, 'ion-button', 6),
              t._uU(15, 'Rejouer'),
              t.qZA()()()),
              2 & e &&
                (t.xp6(5),
                t.Oqu(l.victoryTitle),
                t.xp6(4),
                t.Oqu(t.lcZ(10, 2, l.victory)));
          },
          dependencies: [
            g.ez,
            u.Bz,
